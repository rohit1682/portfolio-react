export const projects = [
  ...
  },
  {
    ...
    tags: ["Node.js", "TypeScript", "Azure Service Bus", "BigCommerce API", "Vitest"],
    github: "https://github.com/rohit1682/paut-failed-orders-fixing-automation",
    live: "#",
    featured: false,
    status: "Completed",
    features: [
      "5-step pipeline: clean → fetch → fix → resend → verify",
      "Extensible handler registry for new error types",
      "Dry-run mode & interactive or fully automated runs",
      "94%+ test coverage with Vitest",
      "CSV and JSON reporting output",
    ],
  },
  {
    id: 10,
    color: "linear-gradient(135deg, #1a1a1a 0%, #2d3436 50%, #636e72 100%)",
    title: "DLQ Cleanup",
    subtitle: "Azure Service Bus Utility",
    description:
      "A Node.js utility for cleaning up outdated messages from Azure Service Bus Dead Letter Queues. Retains the latest N messages and permanently deletes older ones with connection verification.",
    tags: ["Node.js", "Azure Service Bus", "CLI"],
    github: "https://github.com/rohit1682/dlq-cleanup",
    live: "#",
    featured: false,
    status: "Completed",
    features: [
      "Configurable retention count (keep newest N, delete rest)",
      "Connection verification script before cleanup",
      "Sorts by sequence number for accurate retention",
    ],
  },
];
